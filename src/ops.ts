...
function dispatch(id: number, ...args: any[]): Uint8Array {
    return (Deno as any).core.dispatch(id, ...args.map(e => typeof e === "object" ? (e instanceof Uint8Array ? e : JSON.stringify(e)) : String(e)).map(e => typeof e == "object" ? e : encoder.encode(e)));
}
